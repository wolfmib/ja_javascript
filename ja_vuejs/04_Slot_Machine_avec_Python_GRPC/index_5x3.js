...
//<script> const { Slot_object_Ping, Slot_Object_Pong } = require('./compiled_js_proto/proto/gameslot_pb.js')</script>
//<script> const { GameSlotService } = require('./compiled_js_proto/proto/gameslot_grpc_web_pb.js') </script>

const { Slot_object_Ping, Slot_Object_Pong } = require('./compiled_js_proto/proto/gameslot_pb.js')

var my_slot_service = new GameSlotService('http://localhost:9999');
